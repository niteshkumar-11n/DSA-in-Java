class Solution {
    public int computeArea(int ax1, int ay1, int ax2, int ay2, int bx1, int by1, int bx2, int by2) {
        ...
        if((flag1 && flag2) == true )   return (org_area_1+org_area_2) - overlap_area;
        else return org_area_1+org_area_2;
